...
MyData <- Data <- list(J=J, N=N, 
                       ...
                       parm.names=names(parm), y=Abu.10)
#
Iterations <- 50000 
Status <- 2000
Thinning <- 50 
...
#################
#   write.csv(FF2$Summary2, 'possion.distribution 10m.csv')
############################################################################
#   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~     #
#   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~     #
...
#################
#   write.csv(BF$Summary2, 'binomial.distribution 10 m.csv')
############################
Fit <- Fit2
...
dea.10 <- read.csv("DeadData-10m-abun.csv")
head(dea.10)
Abu.10 <- as.numeric(dea.10$Abu > 0)
sum(Abu.10)/length(Abu.10)
hist(Abu.10)
mean(Abu.10)
#
N <- length(Abu.10)
...
#################
#  write.csv(OZ10$Summary2, 'one-zero-binomial.distribution 10 m.csv')
############################
Fit <- Fit2
caterpillar.plot(Fit,Parms= c('BETA','RHO'))
#
...
NB$Summary2
#################
#   write.csv(NB$Summary2, 'NegativeBinomial.distribution 10m.csv')
############################
Fit <- Fit2
caterpillar.plot(Fit,Parms= c('BETA','RHO'))
#
